...
import com.example.springconcurrencystudy.facade.OptimisticLockFacade;
...
class OptimisticLockStockServiceTest {
    ...
    @Autowired
    OptimisticLockFacade facade; // service가 아니라 facade로 실행합니다
    @Autowired
    ...
    @Test
    @DisplayName("낙관적 락을 이용해 문제를 해결합니다")
